...
shell_command= 'cd server; py ../input-writer-cmds-messenger.py 2 0 4 server-file.txt 2>>errors.txt | java -cp .. MessengerWithFiles -l 6001 >server-recvd.txt &'
os.system( shell_command )

time.sleep( 1 ) 

shell_command= 'cd client; py ../input-writer-cmds-messenger.py 0 0 6 client-file.txt 2>>errors.txt | java -cp .. MessengerWithFiles -l 6002 -p 6001 >client-recvd.txt'
os.system( shell_command )
...
shell_command= 'cd server; py ../input-writer-cmds-messenger.py 2 1 2 server-all.txt 2>>errors.txt | java -cp .. MessengerWithFiles -l 6001 >server-recvd.txt &'
os.system( shell_command )

time.sleep( 1 ) 

shell_command= 'cd client; py ../input-writer-cmds-messenger.py 0 1 2 client-all.txt 2>>errors.txt | java -cp .. MessengerWithFiles -l 6002 -p 6001 >client-recvd.txt'
os.system( shell_command )
...
shell_command= 'cd server; py ../input-writer-cmds-messenger.py 2 1 2 server-msg.txt 2>errors.txt | java -cp .. MessengerWithFiles -l 6001 >server-recvd.txt &'
os.system( shell_command )

time.sleep( 1 ) 

shell_command= 'cd client; py ../input-writer-cmds-messenger.py 0 1 2 client-msg.txt 2>errors.txt | java -cp .. MessengerWithFiles -l 6002 -p 6001 >client-recvd.txt'
os.system( shell_command )
...
shell_command= 'cd server; py ../input-writer-cmds-messenger.py 2 1 2 server-msgs.txt 2>>errors.txt | java -cp .. MessengerWithFiles -l 6001 >server-recvd.txt &'
os.system( shell_command )

time.sleep( 1 ) 

shell_command= 'cd client; py ../input-writer-cmds-messenger.py 0 1 2 client-msgs.txt 2>>errors.txt | java -cp .. MessengerWithFiles -l 6002 -p 6001 >client-recvd.txt'
os.system( shell_command )
